...
def nada_main():
    ...
    out1 = Output(r1, "Minimum of 250 and 50", party1)
    out2 = Output(r, "Multiplication of 250 and 50", party1)
    out3 = Output(r3, "Division of 250 and 50", party1)
    out4 = Output(r4, "Value of (a^2-b^2)=(a+b)(a-b) for a=250 and b=50", party1)
